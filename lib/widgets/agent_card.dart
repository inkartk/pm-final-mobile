      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDataRow('← Вход:', input, Icons.arrow_downward, context),
            const SizedBox(height: 8),
            _buildDataRow('⚙ Действие:', action, Icons.settings, context),
            const SizedBox(height: 8),
            _buildDataRow('→ Выход:', output, Icons.arrow_upward, context),
          ],
        ),
      ),
    );
